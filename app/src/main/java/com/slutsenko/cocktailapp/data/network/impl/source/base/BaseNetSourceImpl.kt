package com.slutsenko.cocktailapp.data.network.impl.source.base

import com.google.gson.JsonParseException
import com.google.gson.JsonSyntaxException
import com.google.gson.internal.bind.TypeAdapters
import com.slutsenko.cocktailapp.core.common.exception.ApiException
...
open class BaseNetSourceImpl<ApiService>(private val apiService: ApiService) {
    ...
    protected open fun parseApiErrorException(throwable: Throwable): ApiException {
        ...
        if (throwable is HttpException) {
            ...
            // here change for request() or request. same with url
